...
| **Save** +1 | **Save** -2 | **Save** +3 | **Save** -5 | **Save** -2 | **Save** -4 |
___
**Skills** Stealth +2
...
| **Save** +4 | **Save** +4 | **Save** +3 | **Save** +3 | **Save** +4 | **Save** +2 |
___
...
| **Save** +4 | **Save** +1 | **Save** +3 | **Save** +1 | **Save** +2 | **Save** +2 |
___
...
| **Save** +4 | **Save** +2 | **Save** +3 | **Save** -4 | **Save** +1 | **Save** -1 |
___
**Skills** Perception +5
...
| **Save** +4 | **Save** +5 | **Save** +3 | **Save** +0 | **Save** +5 | **Save** +2 |
___
...
| **Save** +1 | **Save** +1 | **Save** +1 | **Save** -2 | **Save** +0 | **Save** +1 |
___
...
| **Save** +3 | **Save** +1 | **Save** +2 | **Save** -2 | **Save** +1 | **Save** -2 |
___
**Skills** Perception +5
**Immunities** Fire
**Senses** Darkvision 60 ft.; Passive Perception 15
...
| **Save** +3 | **Save** +1 | **Save** +1 | **Save** -4 | **Save** +1 | **Save** -1 |
___
**Skills** Perception +5
...
| **Save** +2 | **Save** +2 | **Save** +2 | **Save** +1 | **Save** +0 | **Save** +1 |
___
...
| **Save** +10 | **Save** +7 | **Save** +5 | **Save** +1 | **Save** +7 | **Save** +8 |
___
**Resistances** Cold
...
| **Save** +5 | **Save** +1 | **Save** +5 | **Save** -4 | **Save** +0 | **Save** -2 |
___
**Skills** Perception +6
...
| **Save** +5 | **Save** +7 | **Save** +9 | **Save** +4 | **Save** +7 | **Save** +9 |
___
...
| **Save** -2 | **Save** +3 | **Save** +1 | **Save** +0 | **Save** +1 | **Save** +2 |
___
...
| **Save** +7 | **Save** -1 | **Save** +5 | **Save** -4 | **Save** +0 | **Save** -5 |
___
...
| **Save** -2 | **Save** +2 | **Save** -1 | **Save** -1 | **Save** -2 | **Save** -1 |
___
**Gear** Daggers (3)
...
| **Save** +3 | **Save** +1 | **Save** +2 | **Save** +2 | **Save** +2 | **Save** +3 |
___
...
| **Save** +0 | **Save** -3 | **Save** +0 | **Save** -5 | **Save** +0 | **Save** -4 |
___
**Resistances** Cold
...
### Reactions
**Protective Magic.** The lich casts *Counterspell* or *Shield* in response to the spell's trigger, using the same spell-casting ability as Spellcasting.
...
| **Save** -1 | **Save** +2 | **Save** +0 | **Save** +6 | **Save** +4 | **Save** +0 |
___
...
| **Save** +0 | **Save** +2 | **Save** +1 | **Save** +9 | **Save** +6 | **Save** +3 |
___
...
| **Save** -2 | **Save** +2 | **Save** +1 | **Save** -1 | **Save** +0 | **Save** +0 |
___
**Immunities** Fire
**Senses** Darkvision 60 ft.; Passive Perception 10
...
| **Save** +3 | **Save** +3 | **Save** +3 | **Save** -2 | **Save** +1 | **Save** -1 |
___
...
| **Save** -3 | **Save** +2 | **Save** +0 | **Save** -1 | **Save** +0 | **Save** +0 |
___
...
| **Save** -1 | **Save** +1 | **Save** +1 | **Save** -2 | **Save** +0 | **Save** +0 |
___
**Skills** Stealth +3
...
| **Save** -3 | **Save** +0 | **Save** +0 | **Save** +0 | **Save** +0 | **Save** +1 |
___
**Skills** Stealth +2
**Immunities** Fire, Poison; Exhaustion, Poisoned
**Senses** Darkvision 60 ft.; Passive Perception 10
...
| **Save** +4 | **Save** +2 | **Save** +2 | **Save** -1 | **Save** +0 | **Save** -1 |
___
**Senses** Darkvision 60 ft.; Passive Perception 10
...
| **Save** +4 | **Save** +0 | **Save** +3 | **Save** -2 | **Save** +3 | **Save** -1 |
___
...
| **Save** +3 | **Save** -1 | **Save** +2 | **Save** -2 | **Save** +3 | **Save** +1 |
___
**Vulnerabilities** Fire
**Immunities** Necrotic, Poison; Charmed, Exhaustion, Frightened, Paralyzed, Poisoned
**Senses** Darkvision 60 ft.; Passive Perception 11
...
| **Save** +4 | **Save** +0 | **Save** +3 | **Save** +5 | **Save** +9 | **Save** +3 |
___
...
**Dread Command.** The mummy casts *Command* (level 2 version), using the same spellcasting ability as Spell-casting. The mummy can't take this action again until the start of its next turn.
...
| **Save** +5 | **Save** +0 | **Save** +11 | **Save** +9 | **Save** +6 | **Save** +7 |
___
**Resistances** Cold, Fire, Lightning
...
| **Save** +4 | **Save** +2 | **Save** +3 | **Save** +3 | **Save** +2 | **Save** +3 |
___
...
| **Save** +0 | **Save** +1 | **Save** +0 | **Save** +1 | **Save** +2 | **Save** +3 |
___
